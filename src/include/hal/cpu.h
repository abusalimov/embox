...
#elif OPTION_MODULE_DEFINED(embox__arch__x86__kernel__smp__cpu, NUMBER, cpu_count)
# define NCPU OPTION_MODULE_GET(embox__arch__x86__kernel__smp__cpu, NUMBER, cpu_count)
#endif
